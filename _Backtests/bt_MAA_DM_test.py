...
from lib.strategy import get_dual_momentum_strategy
from lib.helper import get_start_date_off, get_real_start_trading_date
%matplotlib inline
...
# %%
# Benchmark
def get_benchmark_strategy(name, weight, start_trading_date):
...
# %%
benchmark_strategys = [get_benchmark_strategy(
